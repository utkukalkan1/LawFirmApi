        ...
        <div className="bg-slate-950 text-white">
            <section className="border-b border-white/10">
                <div className="max-w-6xl mx-auto px-6 py-20">
                    <p className="text-xs uppercase tracking-[0.5em] text-amber-200/70 mb-4">İletişim</p>
                    <h1 className="text-4xl md:text-5xl font-semibold mb-4">Dosyanız için hızlı bir değerlendirme yapalım.</h1>
